...
insert into bbop_code(id, category, category_descr, code, code_descr, is_active, created_by, created_date, version) values (next value for bbop_code_seq, 'DOCUMENT_TYPE', 'Document Type', 'DTB', 'Birth Certificate', TRUE, 'SYSTEM', CURRENT_TIMESTAMP, 0);
insert into bbop_code(id, category, category_descr, code, code_descr, is_active, created_by, created_date, version) values (next value for bbop_code_seq, 'DOCUMENT_TYPE', 'Document Type', 'DTP', 'Passport', TRUE, 'SYSTEM', CURRENT_TIMESTAMP, 0);
insert into bbop_code(id, category, category_descr, code, code_descr, is_active, created_by, created_date, version) values (next value for bbop_code_seq, 'DOCUMENT_TYPE', 'Document Type', 'DTS', 'SSS/UMID', TRUE, 'SYSTEM', CURRENT_TIMESTAMP, 0);
insert into bbop_code(id, category, category_descr, code, code_descr, is_active, created_by, created_date, version) values (next value for bbop_code_seq, 'DOCUMENT_TYPE', 'Document Type', 'DTD', 'Driver''s License', TRUE, 'SYSTEM', CURRENT_TIMESTAMP, 0);
insert into bbop_code(id, category, category_descr, code, code_descr, is_active, created_by, created_date, version) values (next value for bbop_code_seq, 'DOCUMENT_TYPE', 'Document Type', 'DTV', 'Voter''s ID', TRUE, 'SYSTEM', CURRENT_TIMESTAMP, 0);
insert into bbop_code(id, category, category_descr, code, code_descr, is_active, created_by, created_date, version) values (next value for bbop_code_seq, 'DOCUMENT_TYPE', 'Document Type', 'DTO', 'Others', TRUE, 'SYSTEM', CURRENT_TIMESTAMP, 0);
